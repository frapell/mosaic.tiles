...
#
#  $ bin/test -s mosaic.tiles -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mosaic.tiles.testing.MOSAIC_TILES_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mosaic/tiles/tests/robot/test_example.robot
#
